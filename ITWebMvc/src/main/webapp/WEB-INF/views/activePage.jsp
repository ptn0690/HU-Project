<%-- 
    Document   : forgetPass
    Created on : Dec 11, 2013, 2:02:39 PM
    Author     : Nhan
--%>
	...
	<!-- Start WOWSlider.com BODY section -->
		<!-- End WOWSlider.com BODY section -->
            ...
            <!--MainAccessories-->
                    	<!--END=Accessories-->
              <!--Vung ben phai-->
    		<form action="ActiveCodeServlet" method="post" >
    		<br><br><br><br><br>
    		<div style="background-color:white;width:60%;margin-left:30%;height:300px">
    		<br><br><br>
				<table style="width: 71%; margin-left:50px" bgcolor="white">
					<tr>
						<td class="auto-style1" colspan="2">Active Code
						</td>
					</tr>
					<tr>
						<td  colspan="2">&nbsp;Please check email and check active code here !
						</td>
					</tr>

					<tr>
						<td class="text-right">Your Active Code:</td>
						<td class="text-left" style="width: 406px"><input name="activeCode" type="text" /></td>
					</tr>
					<tr>
						<td class="text-center" colspan="2">
						<input name="activeButton" type="submit" value="Active" />
