				...
				<table style="width: 80%" border="1px">
					<tr bgcolor="red" style="color:white">
						...
						<input name="delete" type="submit" value="Finish" /></th>
                                    ...
                                    <%
                                        List<Order> orders = (List<Order>) request.getAttribute("listOfOrders");
					...
					<tr>
						<td class="auto-style1">&nbsp;<%=num%></td>
                                                <td class="auto-style1">&nbsp;<a href="${pageContext.request.contextPath}/receipt/detail/<%=each.getId()%>"><%=each.getOrderDate()%></a></td>
