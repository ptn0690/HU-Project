...
<%
    ...
    if(id!=null){
        ...
        PaymentMethod paymentmethod = paymentDAO.findPaymentById(Integer.parseInt(id));
%>
    		<form action="AddOrUpdatePaymentMethodServlet" method="post">
			<table style="width: 75%">
                            <input type="hidden" name="id" value="<%=id%>"/>
				<tr style="width: 20%">
                                    <td>Method Name: </td> 
                                    <td> <input type="text" name="paymethodtxt" value="<%=paymentmethod.getMethod()%>"/></td>
                                </tr>
                            <tr>
                                <td>
